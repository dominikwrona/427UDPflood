...
void *flood(void *par1)
{
  ...
  /* TO-DO
  Create a socket s capable of sending not only UDP packets but raw data including IP headers */
  //
  //
  ...
  iph->tot_len += td->pks;
  /* TO-DO:
  Fill in the destination port in the UDP header. Make sure it is
  in network byte order
  Linux: UDP struct has property dest
  */
  //
  //
...
int main(int argc, char *argv[ ])
{
  ...
  /* To-Do: Create separate threads until num_threads is reached
  that execute the flood function. Make sure to fill in the thread_data struct and use it as
  your pthread_t */
  // To-Do
  // To-Do
